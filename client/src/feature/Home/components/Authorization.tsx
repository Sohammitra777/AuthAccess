  ...
  return (
    <main className="rounded-xl p-6 text-center text-sm tracking-widest text-[#b1ada1] sm:text-2xl/10 md:pr-30 md:pl-30">
      ...
      <div className="flex items-center gap-10">
        ...
        />
        <p>
          Different users unlock different access. The Admin Panel is available
          only for admin accounts, demonstrating role-based permissions,
          protected routes, and controlled UI visibility.
        </p>
      </div>
    </main>
  );
