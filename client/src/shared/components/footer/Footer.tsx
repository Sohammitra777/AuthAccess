...
function Footer() {
    return (
        <div className="mt-4 flex w-full flex-col items-center border-t border-[#2A2A2A] bg-[#0F0F0F] pb-4 font-mono tracking-wide sm:pb-0">
            <h1 className="mt-2 text-sm text-[#C96A45] sm:text-2xl lg:text-3xl">
